...
$date = date("d - M - Y");		
$tinsert="INSERT INTO $tname (emp_name, emp_id,date,cancel_app, apply_app) VALUES('$user', $id, '$date','n','y');";
mysql_query($tinsert);
...
{
//print "DB Closed" . "<br />";
echo "<script type='text/javascript'> document.location = 'create_result.php?error=your application has been sent to admin.'; </script>";
}
else
{
